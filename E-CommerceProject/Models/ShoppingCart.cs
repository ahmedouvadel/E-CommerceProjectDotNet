...
namespace E_CommerceProject.Models
{
    public class ShoppingCart
    {
        ...
        public ShoppingCart(ECommerceDB context)
        {
            _context = context;
        }
        ...
        public static ShoppingCart GetCart(IServiceProvider services)
        {
            ...
            var context = services.GetService<ECommerceDB>();
        ...
        {
            // Ensure that any potential null Price values default to 0 to prevent exceptions.
            return _context.ShoppingCartItems
                           .Where(c => c.ShoppingCartId == Id)
                           .Select(c => (c.Product.Price ?? 0) * c.Amount)
                           .Sum();
        }
    }
}
